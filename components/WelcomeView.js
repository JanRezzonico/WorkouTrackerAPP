  ...
  return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <Modal visible={modalVisible} animationType="slide" onRequestClose={handleModalClose}>
        {modalPage === 'LoginView' && <LoginView onClose={handleModalClose} onLogin={props.onLogin} />}
        {modalPage === 'SignupView' && <SignupView onClose={handleModalClose} onLogin={props.onLogin} />}
      </Modal>
    </SafeAreaView>
  );
};
